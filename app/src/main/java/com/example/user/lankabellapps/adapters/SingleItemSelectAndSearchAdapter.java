 ...
 */
public class SingleItemSelectAndSearchAdapter extends RecyclerView.Adapter<SingleItemSelectAndSearchAdapter.Holder> {
    ...
    public SingleItemSelectAndSearchAdapter(Context context, List<SingleItemModel> singleItemList, SingleItemClickListener singleItemClickListener, String callFrom) {
        mContext = context;
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View row = LayoutInflater.from(mContext).inflate(R.layout.widget_single_search_item, parent, false);
